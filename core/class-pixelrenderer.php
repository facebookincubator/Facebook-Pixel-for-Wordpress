...
class PixelRenderer {
	 ...
	 *
	 * @param array $events The array of events, each event is an array with the following keys:
	 *                      - event_name: the name of the event
	 *                      - event_id: the id of the event (optional)
	 *                      - custom_data: the custom data for the event (optional).
	 * @param bool  $fb_integration_tracking Whether to track the event as a Facebook integration.
	 * @param bool  $script_tag Whether to wrap the generated code with a script tag.
	 *
	 ...
	 *
	 * @param \FacebookPixelPlugin\Core\Event $event The event to generate the track code for.
	 * @param bool                            $fb_integration_tracking Whether to track the event as a Facebook integration.
	 *
	 * @return string The generated track code
	 */
	private static function get_pixel_track_code( $event, $fb_integration_tracking ) {
		...
		if ( ! is_null( $fb_integration_tracking ) ) {
			$normalized_custom_data[ self::FB_INTEGRATION_TRACKING ] = $fb_integration_tracking;
		}
