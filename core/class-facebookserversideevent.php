...
class FacebookServerSideEvent {
	 ...
	 *
	 * @return FacebookServerSideEvent The instance of FacebookServerSideEvent class.
	 */
	...
	/**
	 * Stores a server event that should be sent when a specific callback is fired.
	 *
	 * @param string      $callback_name The name of the callback to listen for.
	 * @param ServerEvent $event The server event to send when the callback is fired.
	 */
	...
	/**
	 * Retrieves a server event that should be sent when a specific callback is fired.
	 *
	 * @param string $callback_name The name of the callback to listen for.
	 * @return ServerEvent|null The server event to send when the callback is fired, or null if no event was stored for the callback.
	 */
	 ...
	 * It will apply the 'before_conversions_api_event_sent' filter to the events
	 * before sending them.
	 *
	...
	private static function is_open_bridge_event( $events ) {
		...
		return 'wp-cloudbridge-plugin' === $custom_properties['fb_integration_tracking'];
	}
}
