...
final class FacebookWordPressOpenBridgeTest extends FacebookWordpressTestBase {
	...
	/**
	 * Test that external_id is fetched from the cookie when obeid exists in the databag.
	 *
	 ...
	 * it is included in the external_id array along with the obeid from the session.
	 *
	 * @covers FacebookWordpressOpenBridge::extract_from_databag
	 */
