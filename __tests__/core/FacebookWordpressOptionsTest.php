...
final class FacebookWordpressOptionsTest extends FacebookWordpressTestBase {
    ...
    /**
     * Tests that the register_user_info method
     * correctly registers the user information.
     *
     * Asserts that:
    ...
    /**
     * Tests that the register_user_info method returns
     * an empty array when the user ID is not available.
     *
     * Asserts that:
    ...
    /**
     * Tests that the register_user_info method does
     * not register the user information
     * when the 'Use Personal Identifiable
     * Information (PII)' setting is disabled.
     *
     * Asserts that:
     *  - The user information is an empty array.
     */
    ...
    /**
     * Tests that the set_version_info method
     * correctly sets the version information
     * and the get_agent_string method returns the agent string with the correct
     * version information.
     *
     * Asserts that:
     *  - The version information is correctly set.
     *  - The agent string is correctly
     * constructed with the version information.
     */
     ...
     *  - The default external business
     * ID is a string that starts with 'fbe_wordpress_'.
     */
     ...
     *
     * @param string $value The string to be
     * returned by the mocked esc_js function.
     */
    ...
    /**
     * Mocks the wp_get_current_user function to
     * return a user object with specified attributes.
     *
     * This method sets up a WP_Mock for the
     * wp_get_current_user function, returning a user
     * object with the given user ID. The user
     * object also includes predefined values for
     * email, first name, and last name, which
     * are useful for testing scenarios where user
     * information is required.
     *
     * @param int $user_id The ID of the user to be
     * returned by the mocked wp_get_current_user function.
     */
