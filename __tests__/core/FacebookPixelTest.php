...
final class FacebookPixelTest extends FacebookWordpressTestBase {
    ...
    /**
     * Asserts that the given code does not start
     * with <script and does not end with </script.
     *
     * @param string $code The code to test.
     *
     * @return void
    ...
    foreach ( $keywords as $keyword ) {
        $this->assertTrue(
            strpos( $code, $keyword ) !==
            false,
            "Failed asserting that '$code' contains '$keyword'"
        );
    }
    }

    /**
     * Asserts that the given function behaves
     * correctly in terms of code pattern.
     *
     * It tests that when no pixel ID is set,
     * the function returns an empty string.
     * It tests that when a pixel ID is set, the
     * function returns a string that starts
     * with <script and ends with </script.
     * It also tests that the string contains
     ...
     *
     * It tests that when no pixel ID is set, the
     * function returns an empty string.
     * It tests that when a pixel ID is set, the function
     * returns a string that starts
     * with <script and ends with </script. It also
     * tests that the string contains
     * the given keyword, as well as the 'track', 'init', and 'agent' keywords.
     * It also tests that if the $with_script_tag
     * parameter is set to false, the returned
     ...
     * It tests that when a pixel ID is set, the
     * function returns a string that starts
     * with <script and ends with </script. It
     * also tests that the string contains
     * the given keyword, as well as the 'track'
     * keyword. It also tests that if the
     * $with_script_tag parameter is set to false,
     * the returned string does not start
     * with <script and does not end with </script.
     * If the $event_name parameter is
    ...
    /**
     * Tests that the get_pixel_initiate_checkout_code
    ...
    \WP_Mock::userFunction(
        ...
        $this->assertCodePattern(
            'get_pixel_initiate_checkout_code',
            'InitiateCheckout'
        );
    }
     ...
     *
     * It tests that when no pixel ID is set, the function
     ...
     * function returns an empty string.
     * It tests that when a pixel ID is set, the function returns a string that
     * contains the given pixel ID, the 'PageView'
     * event name, as well as the given
     * parameters. The parameters should be URL encoded.
     *
     * @return void
     */
     ...
     * returns an empty string.
     * It tests that when a pixel ID is set, the function returns a string that
     * contains the given pixel ID, the 'Purchase'
     * event name, as well as the given
     * parameters. The parameters should be URL encoded.
     *
     * @return void
     ...
     * function returns an empty string.
     * It tests that when a pixel ID is set, the function returns a string that
     * contains the given pixel ID, the 'ViewContent'
     * event name, as well as the given
     * parameters. The parameters should be URL encoded.
     *
     * @return void
