...
final class ServerEventFactoryTest extends FacebookWordpressTestBase {
	...
	/**
	 * Tests that a new event honors the precedence order for determining the client's IP address.
	 *
	 * This test verifies that when both the HTTP_X_FORWARDED_FOR and REMOTE_ADDR
	 ...
	 * the event source URL generated for a new event includes the 'https' scheme.
	 *
	 * @return void
	 */
	 ...
	 * the event source URL generated for a new event includes the 'http' scheme.
	 *
	 * @return void
	 */
	...
	/**
	 * Tests that a new event has the correct event source URL with HTTP when HTTPS is set to 'off'.
	 *
	 * This test verifies that when the HTTPS server variable is explicitly set to 'off',
	 * the event source URL generated for a new event includes the 'http' scheme.
	 *
	 * @return void
	 */
	...
	/**
	 * Tests that a new event has the correct event source URL when the prefer_referer_for_event_src flag is set to true.
	 *
	...
	/**
	 * Tests that the fbclid is extracted from the URL if the FBC cookie is not found.
	 *
	 * This test verifies that when the FBC cookie is not set, the fbclid parameter
	 ...
	 *
	 * This method returns an associative array containing sample user data fields
	 * such as email, first name, last name, phone, state, city, country, zip code,
	 ...
	 *
	 * This method sets up a mock of the AdsPixelSettings class and the FacebookWordpressOptions class.
	 * The AdsPixelSettings class is configured with the given pixel ID, whether AAM is enabled,
	 * and which fields are enabled for AAM.
	 *
	 * The method then sets up the FacebookWordpressOptions class to return the configured AdsPixelSettings
