...
final class FacebookServerSideEventTest extends FacebookWordpressTestBase {
	 ...
	 *
	 * This test ensures that when a 'Lead' event is tracked using the track method,
	 * the number of tracked events increases by one. It verifies that the
	 * get_num_tracked_events method returns the expected count of 1 after tracking
	 * the event.
	 *
	 * @return void
	 */
	 ...
	 * applied to the events array before sending the events using the send method
	 * of FacebookServerSideEvent. It ensures that the filter modifies the events
	 * as expected.
	 *
	 * @return void
	 */
	 ...
	 * the events are stored in the correct order and the correct number of events
	...
	/**
	 * Tests that the set_pending_pixel_event and get_pending_pixel_event methods of FacebookServerSideEvent
	 * store the events correctly.
	 *
	 * This test verifies that when setting a pending pixel event using the set_pending_pixel_event method,
	 * the events are stored in the correct order. It also verifies that the events can be retrieved using the
