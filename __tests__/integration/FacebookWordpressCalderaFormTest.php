<?php
// phpcs:ignoreFile
// TEMPORARILY DISABLED: preserved in-tree pending this integration's Stage 4/5
// conversion to the consolidated Signals/BrowserEvents API. Re-enable and update
