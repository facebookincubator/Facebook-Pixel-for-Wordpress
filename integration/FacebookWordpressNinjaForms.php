...
class FacebookWordpressNinjaForms extends FacebookWordpressIntegrationBase {
	 ...
	 *
	 * This method hooks into the 'ninja_forms_submission_actions' action, which is
	 * triggered during the form submission process in Ninja Forms. It injects code
	 * into the form submission action, which is triggered when the form is submitted
	 * successfully. The code generates a lead event for the form submission and renders
	 * it as pixel code using the PixelRenderer. The resulting code is appended to the
...
<!-- End Meta Pixel Event Code -->
	 ...
	 *
	 * This function extracts user-related data such as email, first name, last name,
	 * phone number, and address details from the $_POST array, commonly used in form
	 * submissions. The extracted data includes:
	 * - 'email': The user's email address.
	 * - 'first_name': The user's first name.
	 * - 'last_name': The user's last name.
	 * - 'phone': The user's phone number.
	 * - 'city', 'state', 'zip', 'country': Address details, where the country must
	 ...
	 * If a matching field is found, its value is returned. If not, null is returned.
	 *
	 * @param array  $form_data The form data as an associative array.
	 * @param string $key The key of the field to retrieve the value for.
	 * @return string|null The value of the field, or null if no matching field is found.
	 */
