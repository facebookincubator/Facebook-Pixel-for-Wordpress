...
abstract class FacebookWordpressIntegrationBase {
	...
	/**
	 * This function should be overridden in derived classes. It is responsible for adding action hooks to WordPress to inject the pixel code.
	 *
	 * @return void
	 */
	 ...
	 *
	 * The hook is added to the WordPress action system. The hook is the $hook_name, which is the name of the hook that triggers the injection of the pixel code.
	 * The callback is a closure that adds a hook to the 'wp_footer' action to inject the pixel code. The hook is added with a priority of 11.
	 *
	 * The function that is called is the $inject_function, which is a static method of the class $classname. The function is called with the parameters $argv.
	 *
	 * The hook is added with a priority of $priority, which is optional and defaults to 11.
	 *
	 * @param array $pixel_fire_for_hook_params {
	 *     Parameters for adding the hook.
	 *
	 *     @type string $hook_name       The name of the hook that triggers the injection of the pixel code.
	 *     @type string $classname       The name of the class that contains the function that injects the pixel code.
	 *     @type string $inject_function The name of the function that injects the pixel code.
