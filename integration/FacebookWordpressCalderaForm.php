...
class FacebookWordpressCalderaForm extends FacebookWordpressIntegrationBase {
	 ...
	 *
	 * Hooks into the `caldera_forms_ajax_return` action and calls the `injectLeadEvent` method.
	 *
	 * @since 0.9.0
	 */
	 ...
	 * @param array $form The form data.
	 *
	 * @return array The form data in the format expected by the `FacebookServerSideEvent` class.
	 */
	 ...
	 *
	 * @return mixed|null The value of the field from $_POST, or null if not found.
	 */
